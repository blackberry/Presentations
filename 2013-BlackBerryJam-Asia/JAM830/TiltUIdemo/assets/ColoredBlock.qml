...
Container {    
    ...
    onOpacityChanged: {
        ...
        // Show the block using an animation as the opacity become 1, this is controlled
        // in main.qml via the orientation of the device.
        if (opacity == 1) {
    ...
    Container {
        ...
        horizontalAlignment: HorizontalAlignment.Fill
        translationY: 30
        maxHeight: bengan.preferredHeight -30
