        ...
        actions: [
            ActionItem {
                ...
                onTriggered: {
		             ...
		             _goodCitizen_HDMI.setTouchMode("translate");
            ...
            ActionItem {
                ...
                onTriggered: {
                    ...
                    _goodCitizen_HDMI.setTouchMode("rotate");
...
/*            
            InvokeActionItem {
				...
				query.uri: "http://www.blackberry.com/"
                onTriggered: {
                }
            },
*/
            ActionItem {
                ...
                onTriggered: {
                    ...
                    _goodCitizen_HDMI.setTouchMode("scale");
